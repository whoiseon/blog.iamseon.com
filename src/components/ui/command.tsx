...
function CommandDialog({
  ...
  return (
    <Dialog {...props}>
      ...
      <DialogContent
        className={cn(
          "top-4 w-full translate-y-0 overflow-hidden rounded-xl! p-0 md:top-1/3 md:min-w-xl",
          className
        )}
...
function CommandInput({
  ...
  return (
    <div data-slot="command-input-wrapper" className="p-0 pb-0">
      <InputGroup className="bg-muted! h-12! rounded-none border-none shadow-none! *:data-[slot=input-group-addon]:pl-3!">
        ...
        <kbd className="text-muted-foreground bg-background dark:bg-background/50 shadow- mr-4 inline-flex h-5 items-center rounded-xs px-1 font-sans text-xs leading-5 font-medium select-none">
          ESC
        </kbd>
      </InputGroup>
    </div>
...
function CommandList({ className, ...props }: React.ComponentProps<typeof CommandPrimitive.List>) {
  return (
    <CommandPrimitive.List
      ...
      className={cn(
        "bg-muted no-scrollbar border-t-input/50 max-h-72 scroll-py-1 overflow-x-hidden overflow-y-auto border-t outline-none",
        className
      )}
      {...props}
    />
